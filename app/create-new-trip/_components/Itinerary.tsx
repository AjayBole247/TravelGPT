...
function Itinerary() {
    ...
    const tripDetailInfo = context?.tripDetailInfo;
  ...
  return (
    <div className="relative w-full max-h-[80vh] overflow-auto">
     ...
     :<Image src={'/forest1.jpg'} alt='travel' width={700} height={900} className='w-full h-full object-cover rounded-3xl'/>
    }
    <h2>Getting to know you to build perfect trip here...</h2>
    </div>
    </div>
  );
}
