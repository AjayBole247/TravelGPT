    ...
    <h2>{tripData?.group_size}</h2>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          className="absolute left-8 top-0 overflow-hidden bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-0% via-neutral-200 to-transparent to-99% md:left-8 w-0.5 mask-[linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]"
        >
          <motion.div
            style={{
            ...
            className="absolute inset-x-0 top-0 w-0.5 rounded-full bg-linear-to-t from-purple-500 via-blue-500 via-10% to-transparent from-0%"
          />
        </div>
      </div>
    </div>
